...
import { registerAuthenticating } from '../mocking/mockAuthenticate';
import { Mocking } from './mocking';
import { registerEditingCreating } from '../mocking/mock-editing-creating';
...
function registerMocking() {
	registerAuthenticating();
	registerEditingCreating();
}

const DEFAULT_BASE_URL = (import.meta.env.VITE_BASE_URL ?? '').toString().trim();
const ROLE = 'content-manager';
